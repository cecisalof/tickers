...
export default function MainPartiesScrutiny(props) {
            ...
            <main>
                ...
                <div className="container text-center main-container">
                    ...
                    <div className="row align-items-center mt-md-1 my-1 mx-3">
                        {/* Progess Bar Content */}
                        <ProgressBar scrutiny={scrutiny} />
                        {/* News columns*/}
                        <News news={news} />
                    </div>
                    {/* MAIN second section */}
                    <PartyFlags width={width} politicalParties={politicalParties} partiesDisplayed={6} isPolls={null}/>
                </div>
            </main>
        </div>
    );
